...
class MainMenu:
    ...
    def fade(self, w, h, slide, side):
        """Función para animar el desplazamiento horizontal del selector de dificultad cuando se presiona una flecha"""
    ...
    def draw_dynamic_menu(self, i=0):
        """Dibujar el cuadro de animación de desplazamiento de dificultad"""
    ...
    def mouse_press(self, event):
        """Función para detectar la pulsación del ratón para la animación de desplazamiento de dificultad del menú principal"""
    ...
    def startplaying(self, event):
        """Función para comenzar el juego si se presiona el botón de nuevo juego"""
